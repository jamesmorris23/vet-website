  ...
  <body>
    ...
    <div class="container">
        ...
        <table class="table">
            <thead>
                <tr>
                    <th scope="col" class="clickable" id="nameHeader" title="The name of the animal given by the owner"><input id="nameFilter" class="form-control form-control-sm" type="text" placeholder="Filter"> <br> Name</th>
                    <th scope="col" class="clickable" id="speciesHeader" title="The breed of the animal specified by the owner (verified on first visit)."><input id="breedFilter" class="form-control form-control-sm" type="text" placeholder="Filter"> <br> Breed</th>
                    ...
                    <th scope="col" class="clickable" id="ownerHeader" title="Indicates the name of the owner(s) as specified on the animals intake sheet."><input id="ownerFilter" class="form-control form-control-sm" type="text" placeholder="Filter"> <br> Owner(s)</th>
                    <th scope="col" class="clickable" id="noteHeader" title="Any notes we have left while the animal has been seen in our practice."><input id="noteFilter" class="form-control form-control-sm" type="text" placeholder="Filter"> <br> Notes</th>
                </tr>
            </thead>
            <tbody id="dogTable">
